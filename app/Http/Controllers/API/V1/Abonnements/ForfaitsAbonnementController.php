...
use App\Models\Abonnements\ForfaitsAbonnementsModels;

class ForfaitsAbonnementController extends Controller
{
    ...
    {
        try {
            return ForfaitsAbonnementsModels::all();
        } catch (\Throwable $e) {
    ...
    public function store(Request $request)
    {
        try {
            ...
            $add_forfait = new ForfaitsAbonnementsModels();
            $add_forfait->forfait = $request->forfait;
    ...
    public function update(Request $request, string $slug)
    {
        try {
            ...
            $update_forfait = ForfaitsAbonnementsModels::where('slug',$slug)->first();
            $update_forfait->forfait = $request->forfait;
    ...
    public function destroy(string $slug)
    {
        ...
        try {
            if (!$slug) :
                ...
                DB::table('forfaits_abonnements_models')->where('slug', $slug)->delete();
